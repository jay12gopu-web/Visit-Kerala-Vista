(() => {
    ...
    const destinations = {
        ...
        gavi: {
            name: 'Gavi',
            coordinates: [9.437208, 77.166066],
            category: 'Wildlife & nature',
            categoryKey: 'nature',
            icon: 'fa-leaf',
            description: 'A regulated eco-tourism landscape of rainforest, reservoirs, cardamom country and guided forest experiences.',
            image: 'https://www.keralatourism.org/images/eco-tourism/destinations/gavi.jpg',
            url: 'destination-gavi.html',
            planUrl: 'itineraries.html',
            rail: false,
            hill: true
        },
        vagamon: {
            name: 'Vagamon',
            aliases: ['Wagamon'],
            coordinates: [9.690952, 76.904783],
            category: 'Hills',
            categoryKey: 'hills',
            icon: 'fa-mountain-sun',
            description: 'Rolling grasslands, pine landscapes and cool hill roads on the Kottayam-Idukki border.',
            image: 'https://www.keralatourism.org/ktadmin/img/pages/share/vagamon-2394-01042025100534-20250401100534.jpg',
            url: 'destination-vagamon.html',
            planUrl: 'itineraries.html',
            rail: false,
            hill: true
        },
        ...
        'silent-valley': {
            ...
            aliases: ['Silent Valley'],
            coordinates: [11.130066, 76.42911],
            category: 'Wildlife & nature',
            categoryKey: 'nature',
            icon: 'fa-tree',
            description: 'A protected Western Ghats rainforest with controlled visitor access from the Mukkali side.',
            image: 'https://www.keralatourism.org/ktadmin/img/pages/tablet/silent-valley-national-park-1721217742_f70793578057884756aa.webp',
            url: 'destination-silent-valley.html',
            planUrl: 'itineraries.html',
            rail: false,
            hill: true
        },
    ...
    const transportAccess = {
        ...
        gavi: { rail: 'Kottayam', railTransfer: 240, airport: 'COK', airportTransfer: 360 },
        vagamon: { rail: 'Kottayam', railTransfer: 150, airport: 'COK', airportTransfer: 240 },
        ...
        'silent-valley': { rail: 'Palakkad', railTransfer: 150, airport: 'CCJ', airportTransfer: 240 },
    ...
    const stopLibrary = {
        ...
        vandiperiyar: { name: 'Vandiperiyar', description: 'A cardamom-growing town on the approach to the Gavi forest road.', why: 'It is the practical place to confirm access, fuel and refreshments before the regulated forest section.', duration: '30-45 min' },
        ...
        erattupetta: { name: 'Erattupetta', description: 'A foothill town on a practical approach towards Vagamon.', why: 'It offers food, fuel and a comfort break before the steeper hill road.', duration: '25-40 min' },
        ...
        perinthalmanna: { name: 'Perinthalmanna', description: 'A well-connected inland town between Kozhikode and Mannarkkad.', why: 'It is a practical meal and rest break before continuing towards the forest gateway.', duration: '30-45 min' },
        mannarkkad: { name: 'Mannarkkad', description: 'The principal town for the road approach to Silent Valley.', why: 'Use it to confirm supplies and current park access before continuing towards Mukkali.', duration: '30-45 min' },
    ...
    const edges = [
        ...
        ['thekkady', 'gavi', 40, 120, ['vandiperiyar']],
        ['thekkady', 'vagamon', 45, 105, ['kuttikkanam']],
        ['kumarakom', 'vagamon', 77, 150, ['erattupetta']],
        ...
        ['kozhikode', 'silent-valley', 89, 180, ['perinthalmanna', 'mannarkkad']],
    ...
    const plans = [
        ...
        { id: 'seven-day', name: '8-Day Classic + Offbeat Kerala', duration: '8 days', pace: 'Balanced', url: 'plan-7-days.html', destinations: ['kochi', 'fort-kochi', 'kadamakkudy', 'munnar', 'thekkady', 'munroe-island', 'varkala', 'thiruvananthapuram'], categories: ['city', 'hills', 'nature', 'water', 'beach'] },
        { id: 'ten-day', name: '11-Day Kerala Deep Dive', duration: '11 days', pace: 'Active', url: 'plan-10-days.html', destinations: ['kochi', 'wayanad', 'munnar', 'thekkady', 'alappuzha', 'varkala', 'thiruvananthapuram'], categories: ['city', 'hills', 'nature', 'water', 'beach'] },
